    ...
    (function () {
      ...
      ((t.utils = {}),
        ...
        (t.utils.clone = function (e) {
          if (e == null) return e;
          for (
            var r = Object.create(null), i = Object.keys(e), n = 0;
            n < i.length;
            n++
          ) {
            var s = i[n],
        ...
        (t.FieldRef = function (e, r, i) {
          ((this.docRef = e), (this.fieldName = r), (this._stringValue = i));
        }),
        (t.FieldRef.joiner = "/"),
      ...
      ((t.Set = function (e) {
        ...
        (t.idf = function (e, r) {
          var i = 0;
          for (var n in e) n != "_index" && (i += Object.keys(e[n]).length);
          var s = (r - i + 0.5) / (i + 0.5);
      ...
      ((t.tokenizer = function (e, r) {
        ...
        for (
          ...
          var l = i.charAt(o),
            a = o - u;
          if (l.match(t.tokenizer.separator) || o == n) {
            if (a > 0) {
              var d = t.utils.clone(r) || {};
              ((d.position = [u, a]),
                (d.index = s.length),
                s.push(new t.Token(i.slice(u, o), d)));
            }
            u = o + 1;
          }
        }
...
`,
        ...
        (t.Pipeline.load = function (e) {
          ...
          return (
            e.forEach(function (i) {
              var n = t.Pipeline.registeredFunctions[i];
              if (n) r.add(n);
              else throw new Error("Cannot load unregistered function: " + i);
            }),
            r
          );
        }),
        ...
        (t.Pipeline.prototype.after = function (e, r) {
          ...
          ((i = i + 1), this._stack.splice(i, 0, r));
        }),
        ...
        (t.Pipeline.prototype.run = function (e) {
          for (var r = this._stack.length, i = 0; i < r; i++) {
            for (var n = this._stack[i], s = [], o = 0; o < e.length; o++) {
              var u = n(e[o], o, e);
              if (!(u == null || u === ""))
                if (Array.isArray(u))
        ...
        (t.Pipeline.prototype.runString = function (e, r) {
          var i = new t.Token(e, r);
          return this.run([i]).map(function (n) {
            return n.toString();
          });
        }),
      ...
      ((t.Vector = function (e) {
        ...
        (t.Vector.prototype.upsert = function (e, r, i) {
          ...
          this.elements[n] == e
            ? (this.elements[n + 1] = i(this.elements[n + 1], r))
            : this.elements.splice(n, 0, e, r);
        }),
        ...
        (t.Vector.prototype.toArray = function () {
          for (
            var e = new Array(this.elements.length / 2), r = 1, i = 0;
      ...
      ((t.stemmer = (function () {
        var e = {
          ...
          E = /^(.+?)e$/,
          B = /ll$/,
          z = new RegExp("^" + s + n + "[^aeiouwxy]$"),
          D = function (h) {
            var g, T, P, c, m, O, R;
            if (h.length < 3) return h;
            if (
              ((P = h.substr(0, 1)),
              P == "y" && (h = P.toUpperCase() + h.substr(1)),
              (c = L),
              (m = f),
              c.test(h)
                ? (h = h.replace(c, "$1$2"))
                : m.test(h) && (h = h.replace(m, "$1$2")),
              (c = y),
              (m = w),
              c.test(h))
            ) {
              var Q = c.exec(h);
              ((c = v), c.test(Q[1]) && ((c = b), (h = h.replace(c, ""))));
            } else if (m.test(h)) {
              var Q = m.exec(h);
              ((g = Q[1]),
                (m = x),
            ...
            if (((c = V), c.test(h))) {
              var Q = c.exec(h);
              ((g = Q[1]), (T = Q[2]), (c = v), c.test(g) && (h = g + e[T]));
            }
            if (((c = j), c.test(h))) {
              var Q = c.exec(h);
              ((g = Q[1]), (T = Q[2]), (c = v), c.test(g) && (h = g + r[T]));
            }
            if (((c = C), (m = N), c.test(h))) {
              var Q = c.exec(h);
              ((g = Q[1]), (c = p), c.test(g) && (h = g));
            } else if (m.test(h)) {
              var Q = m.exec(h);
              ((g = Q[1] + Q[2]), (m = p), m.test(g) && (h = g));
            }
            if (((c = E), c.test(h))) {
              var Q = c.exec(h);
              ((g = Q[1]),
                ...
                (m = S),
                (O = z),
                (c.test(g) || (m.test(g) && !O.test(g))) && (h = g));
            }
            return (
              (c = B),
              (m = p),
              c.test(h) && m.test(h) && ((c = b), (h = h.replace(c, ""))),
              P == "y" && (h = P.toLowerCase() + h.substr(1)),
              h
            );
          };
        return function (_) {
      ...
      ((t.generateStopWordFilter = function (e) {
        ...
        return function (i) {
          if (i && r[i.toString()] !== i.toString()) return i;
        };
      }),
      ...
      ((t.TokenSet = function () {
        ...
        (t.TokenSet.fromArray = function (e) {
          for (
            var r = new t.TokenSet.Builder(), i = 0, n = e.length;
            i < n;
            i++
          )
            r.insert(e[i]);
        ...
        (t.TokenSet.fromFuzzyString = function (e, r) {
          for (
            var i = new t.TokenSet(),
              n = [{ node: i, editsRemaining: r, str: e }];
            n.length;
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                ...
                (v in s.node.edges
                  ? (p = s.node.edges[v])
                  : ((p = new t.TokenSet()), (s.node.edges[v] = p)),
        ...
        (t.TokenSet.fromString = function (e) {
          for (
            var r = new t.TokenSet(), i = r, n = 0, s = e.length;
            n < s;
            n++
          ) {
            var o = e[n],
        ...
        (t.TokenSet.prototype.toArray = function () {
          for (var e = [], r = [{ prefix: "", node: this }]; r.length; ) {
            ...
            for (var o = 0; o < s; o++) {
              var u = n[o];
              r.push({ prefix: i.prefix.concat(u), node: i.node.edges[u] });
            }
          }
          return e;
        }),
          ...
          for (
            ...
            for (
              var s = Object.keys(i.qNode.edges),
                o = s.length,
                u = Object.keys(i.node.edges),
                l = u.length,
                a = 0;
              a < o;
              a++
            )
              for (var d = s[a], v = 0; v < l; v++) {
                var p = u[v];
                if (p == d || d == "*") {
                  var S = i.node.edges[p],
                    x = i.qNode.edges[d],
                    L = S.final && x.final,
                    f = void 0;
                  (p in i.output.edges
                    ? ((f = i.output.edges[p]), (f.final = f.final || L))
                    : ((f = new t.TokenSet()),
                      (f.final = L),
                      (i.output.edges[p] = f)),
                    n.push({ qNode: x, output: f, node: S }));
                }
              }
          }
          return r;
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (var l = 0; l < r.clauses.length; l++) {
            var a = r.clauses[l],
              ...
              v = t.Set.empty;
            a.usePipeline
              ? (d = this.pipeline.runString(a.term, { fields: a.fields }))
              : (d = [a.term]);
            for (var p = 0; p < d.length; p++) {
              var S = d[p];
              a.term = S;
              var x = t.TokenSet.fromClause(a),
                L = this.tokenSet.intersect(x).toArray();
              if (L.length === 0 && a.presence === t.Query.presence.REQUIRED) {
              ...
              for (var w = 0; w < L.length; w++)
                for (
                  var b = L[w], k = this.invertedIndex[b], I = k._index, f = 0;
                  f < a.fields.length;
                  f++
                ) {
                  var y = a.fields[f],
                  ...
                  if (
                    ...
                    (u[y] === void 0 && (u[y] = t.Set.empty),
                      (u[y] = u[y].union(j)));
                    continue;
                  }
                  if (
                    (n[y].upsert(I, a.boost, function (J, G) {
                      return J + G;
                    }),
                    !s[V])
                  ) {
                    for (var C = 0; C < F.length; C++) {
                      var N = F[C],
                        E = new t.FieldRef(N, y),
                        B = A[N],
                        z;
                      (z = i[E]) === void 0
                        ? (i[E] = new t.MatchData(b, y, B))
                        : z.add(b, y, B);
                    }
                    s[V] = !0;
                  }
          ...
          for (
            var D = t.Set.complete, _ = t.Set.empty, l = 0;
            l < this.fields.length;
            l++
          ) {
            var y = this.fields[l];
            (o[y] && (D = D.intersect(o[y])), u[y] && (_ = _.union(u[y])));
          }
          var h = Object.keys(i),
            g = [],
          ...
          if (r.isNegated()) {
            ...
            for (var l = 0; l < h.length; l++) {
              var E = h[l],
                P = t.FieldRef.fromString(E);
              i[E] = new t.MatchData();
            }
          }
          for (var l = 0; l < h.length; l++) {
            var P = t.FieldRef.fromString(h[l]),
              c = P.docRef;
            if (D.contains(c) && !_.contains(c)) {
              var m = this.fieldVectors[P],
                O = n[P.fieldName].similarity(m),
                R;
              if ((R = T[c]) !== void 0)
                ((R.score += O), R.matchData.combine(i[P]));
              else {
                var Q = { ref: c, score: O, matchData: i[P] };
                ((T[c] = Q), g.push(Q));
              }
            }
          }
          return g.sort(function ($, U) {
      ...
      ((t.Builder = function () {
        ...
        (t.Builder.prototype.add = function (e, r) {
          ...
          for (var s = 0; s < n.length; s++) {
            var o = n[s],
              ...
              d = this.pipeline.run(a),
              v = new t.FieldRef(i, o),
              p = Object.create(null);
            ((this.fieldTermFrequencies[v] = p),
            ...
            for (var S = 0; S < d.length; S++) {
              ...
              if (
                ...
                for (var f = 0; f < n.length; f++)
                  L[n[f]] = Object.create(null);
                this.invertedIndex[x] = L;
              }
              this.invertedIndex[x][o][i] == null &&
                (this.invertedIndex[x][o][i] = Object.create(null));
              for (var y = 0; y < this.metadataWhitelist.length; y++) {
                var w = this.metadataWhitelist[y],
                  b = x.metadata[w];
                (this.invertedIndex[x][o][i][w] == null &&
                  (this.invertedIndex[x][o][i][w] = []),
                  this.invertedIndex[x][o][i][w].push(b));
              }
            }
          }
        }),
        ...
        (t.MatchData = function (e, r, i) {
          for (
            var n = Object.create(null), s = Object.keys(i || {}), o = 0;
            o < s.length;
            o++
          ) {
            var u = s[o];
        ...
        (t.MatchData.prototype.combine = function (e) {
          for (var r = Object.keys(e.metadata), i = 0; i < r.length; i++) {
            var n = r[i],
              s = Object.keys(e.metadata[n]);
            this.metadata[n] == null &&
              (this.metadata[n] = Object.create(null));
            for (var o = 0; o < s.length; o++) {
              var u = s[o],
                l = Object.keys(e.metadata[n][u]);
              this.metadata[n][u] == null &&
                (this.metadata[n][u] = Object.create(null));
              for (var a = 0; a < l.length; a++) {
                var d = l[a];
                this.metadata[n][u][d] == null
                  ? (this.metadata[n][u][d] = e.metadata[n][u][d])
                  : (this.metadata[n][u][d] = this.metadata[n][u][d].concat(
                      e.metadata[n][u][d],
                    ));
              }
            }
        ...
        (t.MatchData.prototype.add = function (e, r, i) {
          ...
          for (var n = Object.keys(i), s = 0; s < n.length; s++) {
            ...
            o in this.metadata[e][r]
              ? (this.metadata[e][r][o] = this.metadata[e][r][o].concat(i[o]))
              : (this.metadata[e][r][o] = i[o]);
          }
        }),
        (t.Query = function (e) {
        ...
        (t.QueryLexer.prototype.sliceString = function () {
          for (
            var e = [], r = this.start, i = this.pos, n = 0;
          ...
          if (r != null) {
            ...
            switch (s.type) {
              ...
              default:
                ...
                throw new t.QueryParseError(n, s.start, s.end);
            }
          }
        }),
  ...
  (function () {
    ...
    (n.open("GET", "../search-stopwords.json"),
      (n.onload = function () {
        this.status == 200 && ((r = JSON.parse(this.responseText)), o());
      }),
      n.send());
    var s = new XMLHttpRequest();
    (s.open("GET", "../index.json"),
      (s.onload = function () {
        this.status == 200 &&
      ...
      (onmessage = function (l) {
        ...
        (d.forEach(function (p) {
          ...
          postMessage({ e: "query-ready", q: a, d: v }));
      }));
    function o() {
      r !== null &&
        !u(i) &&
        (e = t(function () {
          ...
          for (var l in i) i.hasOwnProperty(l) && this.add(i[l]);
          var a = t.generateStopWordFilter(r);
          (t.Pipeline.registerFunction(a, "docfxStopWordFilter"),
            this.pipeline.add(a),
            this.searchPipeline.add(a));
        }));
    }
    function u(l) {
      if (!l) return !0;
      for (var a in l) if (l.hasOwnProperty(a)) return !1;
      return !0;
    }
  })();
})();
