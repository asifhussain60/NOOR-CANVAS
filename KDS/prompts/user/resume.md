...
## How It Works
1. ✅ Reads `KDS/sessions/current-session.json`
...
Context Files (Read These for Full Context):
📄 KDS/KDS-DESIGN.md (v4.3.0 - SINGLE SOURCE OF TRUTH)
📄 KDS/docs/KDS-ANTI-PATTERNS.md (8 anti-patterns documented)
📄 KDS/docs/v4.3-implementation-summary.md (full implementation details)
