...
- `KDS/prompts/shared/publish.md` → Capacity checks, quality gates, sunset policy
- `KDS/prompts/shared/mandatory-post-task.md` → Knowledge health monitoring
...
2. **`KDS/docs/KDS-ANTI-PATTERNS.md`**
...
4. **`KDS/governance/rules.md` (v4.3.0)**
...
- ✅ All context stored in `KDS/sessions/current-session.json`
