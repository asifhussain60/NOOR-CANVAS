...
test.describe("Issue-107 Fix Validation - Simple API Test", () => {
  ...
  test("should validate the API fix is working with camelCase properties", async ({
    request,
  }) => {
    console.log(
      "=== Issue-107 Fix Validation: Testing camelCase Property Fix ===",
    );
    ...
    if (response.status() === 200) {
      console.log(
        "✅ SUCCESS: Issue-107 fix is working! API accepts camelCase properties.",
      );
