...
async function globalTeardown() {
    ...
    try {
        ...
        if (isRunning) {
            ...
            console.log('⚠️ Application appears to have stopped during test execution');
        }

        // Clean up database connections
        await DatabaseTokenManager.closeConnection();

        console.log('📊 Test artifacts available in: PlayWright/reports/ and PlayWright/artifacts/');
        console.log('🔄 Application continues running for potential manual testing');
