...
test.describe('Issue-114 Fix Verification: Countries Dropdown Loading', () => {
    ...
    test('should load countries dropdown after token validation with HttpClient fix', async ({ page }: { page: Page }) => {
        console.log('🔧 VERIFICATION: Testing HttpClient fix for countries dropdown...');
    ...
    test('should show proper loading state during countries fetch', async ({ page }: { page: Page }) => {
