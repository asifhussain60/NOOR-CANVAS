...
test.describe('HtmlAgilityPack Asset Processing Tests', () => {
  test('Host Controller - Process HTML Assets API endpoint', async ({ page }) => {
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Starting HtmlAgilityPack asset processing test',
    );
    ...
    const response = await page.request.post(
      'https://localhost:9091/api/host/process-html-assets',
      {
        data: {
          sessionId: 12345,
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] API Response Status:',
      response.status(),
    );
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] API Response Data:',
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Successfully detected',
      responseData.assetCount,
      'assets using HtmlAgilityPack',
    );
  });

  test('Asset Extraction API endpoint', async ({ page }) => {
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Testing asset extraction functionality',
    );
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Extract Asset Response Status:',
      response.status(),
    );
    ...
    const responseData = await response.json();
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Extract Response:',
      JSON.stringify(responseData, null, 2),
    );
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Successfully extracted asset with HtmlAgilityPack processing',
    );
  });

  test('Host Control Panel Enhanced Asset Processing Integration', async ({ page }) => {
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Testing HostControlPanel integration with enhanced asset processing',
    );
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] HostControlPanel loaded successfully with enhanced asset processing capability',
    );
    ...
    if ((await transcriptArea.count()) > 0) {
      console.log(
        '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Found transcript area - enhanced processing would be triggered for session content',
      );
    }

    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Enhanced asset processing integration test completed successfully',
    );
  });

  test('Service Registration and Dependency Injection Validation', async ({ page }) => {
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] Validating AssetHtmlProcessingService registration',
    );
    ...
    console.log(
      '[DEBUG-WORKITEM:assetshare:continue:092912484-cont1] AssetHtmlProcessingService is properly registered and injectable',
    );
  });
});
