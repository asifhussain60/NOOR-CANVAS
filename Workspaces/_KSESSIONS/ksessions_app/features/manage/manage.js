(function() {
    "use strict";
    var controllerId = "manageCtl";
    angular.module("app").controller(controllerId,
    ["$scope", "common", "config", "datacontext", "globalData", manageCtl]);

    function manageCtl($scope, common, config, gData) {
        ...
        $scope.g.navConfig.pageTitle = "";
        $scope.g.navConfig.adminTitle = "";
        ...
        function activateController() {
            ...
            function onControllerActivation(result) {
                ...
                log("Activated manage View", controllerId, config.showDevToasts);
            }
        }
