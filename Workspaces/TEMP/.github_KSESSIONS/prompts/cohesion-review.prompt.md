...
1. **InfrastructureQuickRef.md**
   ...
   - Schema access rules ({{SCHEMA_PRIMARY}}.* vs {{SCHEMA_READONLY}}.*)
...
**{{SCHEMA_PRIMARY}}.* Schema Tables** (4 found):
- canvas.AssetLookup ✅
- canvas.Sessions ✅
- canvas.Participants ✅
- canvas.SessionData ✅

**{{SCHEMA_READONLY}}.* Schema Tables** (sample, 47 total):
...
**Script Actions**:
1. **Queries {{DATABASE_NAME}}** for actual {{SCHEMA_PRIMARY}}.* and {{SCHEMA_READONLY}}.* tables
