...
### What
The **Self-Learning Analysis Agent** transforms {{PROJECT_NAME}} from a static instruction set into a continuously improving, self-optimizing AI agent ecosystem by analyzing historical task outcomes, identifying patterns, and updating system knowledge automatically.
...
Your mission is to transform the {{PROJECT_NAME}} system from a static instruction set into a continuously improving, self-optimizing AI agent ecosystem by learning from past executions.
...
- Analyze patterns by technology:
  ...
  - {{REALTIME_TECH}} message handling
  - Entity Framework query efficiency
  - {{TEST_FRAMEWORK}} test reliability
