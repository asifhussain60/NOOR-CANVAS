...
- **-test** *(flag, optional)*  
  ...
  **Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 1 (Healthcheck Invocation Examples)
...
**All KDS validation algorithms referenced from shared scripts:**

**1. Document-First Protocol Compliance:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 2 (KDS Document-First Protocol Validation)

**2. Work Log Continuity Validation:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 3 (Work Log Continuity Validation)

**3. Test Registry Completeness Validation:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 4 (Test Registry Completeness Validation)

**4. Plan-to-Implementation Mapping:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 5 (Plan File Reference Validation)

**5. KDS Directory Structure Validation:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 6 (KDS Directory Structure Validation)

**6. .github Folder Organization Validation:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 7 (.github Folder Organization Validation)

**7. Cross-Key Dependency Validation:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 8 (Cross-Key Dependency Validation)

**8. Copilot Workspace Compliance Validation:**

**Algorithm:** See `.github/prompts/shared/healthcheck-scripts.md` - Script 9 (Copilot Workspace Compliance Validation)
