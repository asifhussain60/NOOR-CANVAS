...
**Files Changed**:
- `.github/prompts/feature.prompt.md` (interruptedAt schema)
...
**Implementation**:
- Added Step 10 to `feature.prompt.md`: "Learning Extraction"
...
- Added `skip-learning` parameter to feature.prompt.md
...
**Files Changed**:
- `.github/prompts/feature.prompt.md` (+88 lines, -9 lines)
...
**Implementation**:
- Added Step 0.5.7 to `feature.prompt.md`: "Reusable Test Discovery"
...
**Files Changed**:
- `.github/prompts/feature.prompt.md` (+108 lines)
...
**Status**: Updated  
**Action**: Enhanced feature.prompt.md with explicit handoff execution instructions  
...
**Key Updates**:
- feature planning agent must SEND @workspace /task command (not just document it)
...
**Files Modified**:
- `.github/prompts/feature.prompt.md` (Step 6, Protocol, Mistakes, Notes sections)
...
3. Learning Integration — Automatic learning extraction (Step 10 in feature.prompt.md)
...
3. **task.prompt.md - Deprecated Step 2.10**
   ...
   - Added note explaining move to feature.prompt.md Step 0.6
...
1. **feature.prompt.md - Comprehensive Test Suite section added to Test Plan**
...
2. **feature.prompt.md - Orchestration script template for full regression**
...
3. **feature.prompt.md - Final Validation Phase template**
...
4. **feature.prompt.md - JSON schema already includes comprehensiveTestSuite field**
...
- ✅ Branch verification working (test-generation.prompt.md Step 0.1, feature.prompt.md Step 0.1)
- ✅ Image analysis moved to plan (feature.prompt.md Step 0.6, task deprecated)
...
**Files Modified:** 3
- .github/prompts/feature.prompt.md (+205 lines: Step 0.6, comprehensive test suite)
...
**Analyst**: GitHub Copilot
**Request**: Review feature.prompt.md, task.prompt.md, test-generation.prompt.md holistically. Identify risks, assumptions, inefficiencies, and recommend enhancements.
...
2. **Phase 2** (P0): Add branch verification to test-generation.prompt.md Step 0.1 and feature.prompt.md Step 0.1
3. **Phase 3** (P1): Move image analysis from task.prompt.md Step 2.10 to feature.prompt.md Step 0.6
