# Binary vs Text Format Analysis for feature.prompt.md
...
**Current:** JSON schema defined in feature.prompt.md  
...
- feature.prompt.md: 50-60 KB (stable, rarely changes)
...
**File Analyzed:** feature.prompt.md (56.5 KB)  
