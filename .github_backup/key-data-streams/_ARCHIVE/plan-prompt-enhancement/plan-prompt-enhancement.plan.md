...
Transform feature.prompt.md into a comprehensive phased execution orchestrator that generates detailed implementation plans with built-in tracking, testing, and validation.
...
- **Documentation Layer**: feature.prompt.md, {key}.plan.md templates
...
**Files to Modify**:
- `.github/prompts/feature.prompt.md` (primary target)
...
1. Add `github-branch` parameter to feature.prompt.md
...
**Files to Analyze**:
- `.github/prompts/feature.prompt.md` (lines 1-350)
...
Add github-branch parameter and technology stack scanning to feature.prompt.md
...
**Files to Analyze**:
- `.github/prompts/feature.prompt.md` (current state from Phase 1)
- `.github/prompts.keys/hcp/work-log.md` (work log patterns)
- `.github/prompts.keys/userlanding/` (comprehensive key structure)
...
**Files to Analyze**:
- `.github/prompts/feature.prompt.md` (current state from Phase 2)
- `.github/prompts/test-generation.prompt.md` (test generation patterns)
- `.github/prompts/shared/playwright-test-generation.md` (test type decisions)
- `.github/prompts/shared/test-orchestration-patterns.md` (PowerShell patterns)
- `.github/instructions/Links/PlaywrightQuickRef.md` (Playwright best practices)
...
**Files to Analyze**:
- `.github/prompts/feature.prompt.md` (current state from Phase 3)
...
**Files to Analyze**:
- `.github/prompts/feature.prompt.md` (current state from Phase 4)
...
**Files to Analyze**:
- `.github/prompts/feature.prompt.md` (current state from Phase 5)
...
- [ ] **Task 6.5**: **[C] Document interactive preview mode usage**
  ...
  - How to trigger preview: feature planning agent shows preview before phase execution
...
N/A - This is a meta-planning enhancement (documentation-only changes to feature.prompt.md)
...
**Success Criteria**:
- ✅ feature.prompt.md successfully generates {key}.plan.md for sample key
...
**Implementation**: Before phase execution, feature planning agent displays:
- Files to be modified (with line ranges)
- Estimated lines of code to change
...
```
Enhanced feature.prompt.md with phased execution, test automation, and comprehensive tracking (Enhancements: A,B,C,D,E,G)
```
