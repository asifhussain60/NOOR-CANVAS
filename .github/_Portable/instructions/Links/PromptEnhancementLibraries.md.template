...
This document catalogs established prompt engineering libraries that can enhance AI agent capabilities through structured prompting, optimization, testing, and orchestration. These are **optional enhancement tools** - the {{PROJECT_NAME}} prompt system is functional without them.
...
**Integration Considerations**:
- **HIGHEST COMPATIBILITY** - native {{LANGUAGES}} integration
...
| Library | Language | Primary Use Case | {{LANGUAGES}} Support | Self-Hostable | License |
|---------|----------|-----------------|------------|---------------|---------|
| **DSPy** | Python | Prompt Optimization | ❌ | ✅ | MIT |
| **Guidance** | Python | Constrained Generation | ❌ | ✅ | MIT |
| **LangChain** | Python/JS | Orchestration | ❌ | ✅ | MIT |
| **Semantic Kernel** | **{{LANGUAGES}}**/Python/Java | Enterprise Orchestration | ✅ | ✅ | MIT |
...
1. **Semantic Kernel ({{LANGUAGES}})**
   - **Why**: Native {{LANGUAGES}} support, enterprise-grade, Microsoft-backed
...
1. **Install {{PACKAGE_MANAGER}} Package**:
   ```bash
...
2. **Create Config** (`.github/promptfooconfig.yaml`):
   ```yaml
   description: {{PROJECT_NAME}} Agent Prompt Tests
