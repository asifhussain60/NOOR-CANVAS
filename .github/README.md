...
```bash
# Edit template
code .github/templates/user-output/plan-complete.mustache
...
All handoff files validated against `.github/schemas/handoffs/handoff-schema.json`:
...
All prompt outputs validated against XML schemas in `.github/schemas/outputs/`:
...
| **govern.prompt.md** | Governance compliance | .github change | Approval/rejection |
...
4. Check existing work logs in `.github/keys/{key}/work-log.md`
