...
This plan implements critical enhancements to the three core orchestration prompts (feature.prompt.md, task.prompt.md, test-generation.prompt.md) based on holistic analysis and user requirements.
...
- Error messages guide users to run @workspace /feature first
...
- Confirmed error messages include correct @workspace /feature invocation
...
2. Enhance branch parameter validation in feature.prompt.md
...
- [ ] **Task 2.2:** Add Step 0.1 to feature.prompt.md
  ...
  - Expected outcome: feature planning agent warns about master branch usage
...
- [ ] feature planning agent warns if github-branch=master at Step 0.1
...
- feature.prompt.md: New Step 0.1 validates github-branch parameter
...
- .github/prompts/feature.prompt.md (added Step 0.1)
...
- [ ] **Task 3.1:** Add Step 0.6 to feature.prompt.md
...
- [ ] **Task 3.2:** Add vision tool usage instructions
  - Location: Step 0.6 in feature.prompt.md
...
- [ ] **Task 3.3:** Update plan deliverables template
  - Location: "Handoff Templates" section in feature.prompt.md
...
- [ ] feature planning agent analyzes images at Step 0.6
...
- feature.prompt.md: New Step 0.6 for Image Analysis & Requirement Extraction
- feature.prompt.md: Added vision tool usage instructions
- feature.prompt.md: Updated handoff templates to include annotate parameter
...
Files modified:
- .github/prompts/feature.prompt.md (added Step 0.6, updated templates)
...
- [ ] **Task 4.1:** Add comprehensive test suite to plan template
  - Location: "Test Plan" section in feature.prompt.md
...
- [ ] **Task 4.2:** Add orchestration script template
  - Location: "Orchestration Script Specification" in feature.prompt.md
...
- [ ] **Task 4.3:** Add final validation phase to plan template
  - Location: "Phase Breakdown" section in feature.prompt.md
...
- [ ] **Task 4.4:** Update plan.json tracking
  - Location: JSON schema in feature.prompt.md
...
- feature.prompt.md: Comprehensive test suite template in Test Plan section
- feature.prompt.md: Orchestration script for full regression testing
- feature.prompt.md: Final validation phase with comprehensive testing
- feature.prompt.md: Updated plan.json schema to track comprehensive suite
...
Files modified:
- .github/prompts/feature.prompt.md (added comprehensive suite generation)
...
- Error message includes: `@workspace /feature key=nonexistent user_request=...`
...
### Test 4: Image Analysis (feature.prompt.md)

**Scenario:** Plan generation with annotated mockup

**Steps:**
1. Create annotated mockup image (PNG with text annotations)
2. Run plan: `@workspace /feature key=test-image user_request="Implement feature from mockup" annotate="mockup.png"`
