...
The NOOR CANVAS application uses **four specialized HTML services**, each with distinct responsibilities:
...
**Location**: `SPA/NoorCanvas/Services/HtmlParsingService.cs`  
...
**Location**: `SPA/NoorCanvas/Services/AssetHtmlProcessingService.cs`  
...
**Location**: `SPA/NoorCanvas/Services/AssetProcessingService.cs`  
...
**Location**: `SPA/NoorCanvas/Services/HtmlTransformPatterns.cs`  
...
### Unit Tests:
- ✅ `Tests/Unit/HtmlParsingServiceTests.cs` (8 test methods)
...
### Integration Tests:
- ✅ Playwright visual regression tests for asset sharing
