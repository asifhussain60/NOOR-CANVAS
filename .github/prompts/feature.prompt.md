# feature.prompt.md (Feature Planning Agent v1.0)
...
- ❌ Not the intended protocol per feature.prompt.md
...
This step uses AI-powered vision analysis to:
- Extract requirements from annotated mockups, design comps, plain screenshots, and error screenshots
- Convert visual annotations to structured requirements (visual, functional, technical constraints)
- Generate Percy test specifications automatically
- Confirm understanding with user before incorporating into plan

**Integration Point:**
- Requirements extracted here are added to "Goals and success criteria" in Step 2 (Plan Draft)
- Visual specifications become phase deliverables and acceptance criteria
- Percy test scenarios auto-generated from visual requirements

For complete image analysis workflow, classification taxonomy, and vision tool instructions, see the shared module.
...
- Phase breakdown algorithm (concept extraction, layer mapping, dependency analysis)
- Phase generation and naming conventions
- Intelligent enhancement recommendation system
- Database migration protocol (MANDATORY for database changes)

All phase breakdown logic, enhancement recommendations, and migration workflows are defined in the shared module.
