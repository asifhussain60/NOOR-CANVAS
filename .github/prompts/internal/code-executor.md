...
Step 6: Update Session
  #replace_string_in_file .github/sessions/current-session.json
  "task_id": "1.2",
  "status": "in_progress"
  →
  "task_id": "1.2",
...
Next: 
  #file:.github/prompts/user/validate.md (health check)
  #file:.github/prompts/shared/publish.md (publish patterns)
```
...
If 3+ failures:
  #file:.github/prompts/user/correct.md
...
Action:
  1. Load #file:.github/prompts/shared/validation.md
...
```markdown
#file:.github/prompts/shared/test-first.md (TDD workflow)
#file:.github/prompts/shared/handoff.md (handoff protocol)
