...
- `.github/KDS-DESIGN.md` - v4.0 living design document (updated continuously)
- `.github/governance/rules.md` - Machine-readable governance rules

### Priority 2: Published Knowledge (Validated Patterns)
- `.github/knowledge/test-patterns/` - Successful Playwright patterns
- `.github/knowledge/test-data/` - Validated test data (session IDs, test images)
- `.github/knowledge/ui-mappings/` - UI element to testid mappings
- `.github/knowledge/workflows/` - Proven workflow patterns

### Priority 3: Implementation Files (Ground Truth)
- `.github/prompts/user/` - User-facing prompt commands
- `.github/prompts/internal/` - Internal agent implementations
- `.github/prompts/shared/` - Shared workflow logic
- `.github/schemas/` - JSON/XML validation schemas
- `.github/templates/` - Mustache output templates
- `.github/hooks/` - Git hook scripts

### Priority 4: Architecture Documentation (Design Rationale)
- `.github/docs/architecture/KDS-DESIGN-PLAN.md` - v3.0 complete redesign plan
- `.github/docs/architecture/KDS-V3-IMPLEMENTATION-PLAN.md` - Industry best practices
- `.github/docs/guides/PHASE-0-COMPLETE.md` - Phase 0 implementation summary

### Priority 5: Operational Documentation (Reference)
- `.github/docs/guides/QUICK-REFERENCE.md` - Quick command reference
- `.github/docs/DIRECTORY-STRUCTURE.md` - Folder organization
...
def validate_folder_structure():
    ...
    actual_folders = list_directories(".github/")
...
## Error Handling
- **No sources found**: Search broader (include Legacy .github_backup/), inform user
