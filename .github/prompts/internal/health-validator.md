...
**Version:** 4.5  
**Loaded By:** `.github/prompts/user/validate.md`
...
Working Directory:
  Modified:   2 files
    - .github/prompts/user/validate.md
...
Recommendations:
  1. Review modified files:
     git diff .github/prompts/user/validate.md
...
#file:.github/KDS-DESIGN.md (quality standards)
```
...
Next: #file:.github/prompts/user/correct.md (fix errors)
```
