...
**Version:** 4.5  
**Loaded By:** `.github/prompts/user/test.md`
...
### Always Load
```markdown
#file:.github/governance/rules.md (Rule #8: Test-First)
#file:.github/KDS-DESIGN.md (testing philosophy)
```
...
### After Test Creation
```markdown
Load #file:.github/prompts/shared/publish.md
...
#file:.github/prompts/shared/publish.md (pattern publishing)
...
Next: #file:.github/prompts/user/execute.md (continue development)
```
