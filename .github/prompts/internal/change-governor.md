...
**Version:** 4.5  
**Loaded By:** `.github/prompts/user/govern.md`
...
```json
{
  ...
  "files_modified": ["array of .github/ paths"],
...
```json
{
  ...
  "changes_detected": [
    {
      "file": ".github/prompts/shared/test-first.md",
      "type": "deleted",
      "lines_changed": 250
    }
  ],
...
### Git Diff Analysis
```bash
# Detect modified files in .github/
git diff --name-status .github/

# Parse output
M    .github/prompts/internal/test-generator.md   (Modified)
A    .github/prompts/user/new-prompt.md           (Added)
D    .github/prompts/shared/old-module.md         (Deleted)
```
...
Change: Create .github/prompts/archive/
...
Action:
  1. Log override to .github/governance/overrides.log
...
### Load Shared Modules
```markdown
#file:.github/prompts/shared/validation.md (validation helpers)
```

### Update Design Documents
```markdown
IF decision == APPROVED:
  #replace_string_in_file .github/KDS-DESIGN.md
  (add design decision entry)
  
IF rule changed:
  #replace_string_in_file .github/governance/rules.md
  (update rule)
```
