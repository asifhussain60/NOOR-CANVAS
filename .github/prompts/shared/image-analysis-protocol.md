...
**Note**: Image analysis was previously in task.prompt.md's `annotate` parameter but has been moved to plan.prompt.md.
...
- **plan.prompt.md** - Invokes this protocol in Step 0.6
- **task.prompt.md** - Deprecated `annotate` parameter (now suggests using plan.prompt.md)
...
### v1.0.0 (2025-10-21)
- Initial creation
- Extracted from plan.prompt.md Step 0.6
