...
- **Reads From**: All agent key data streams in `.github/key-data-streams/`
...
- Query **`.github/key-data-streams/`** for historical key data streams.
...
- **KEY DATA STREAM:** Document all analysis results in `.github/key-data-streams/learning-analysis/work-log.md`
...
### 1. Data Collection
- Query `.github/key-data-streams/` based on scope parameter
...
**Key Data Stream Path**: `.github/key-data-streams/learning-analysis/work-log.md`
