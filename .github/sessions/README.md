...
```
@workspace Read .github/sessions/resumption-guide.md
```
...
```
User: @workspace /execute #file:.github/keys/v4.3/handoffs/task-1.json
...
🔄 Implement publishing guardrails
   Duration: ~30 minutes
   Command: @workspace /execute #file:.github/keys/v4.3/handoffs/task-2.json

Context Files:
- .github/KDS-DESIGN.md (v4.3.0)
- .github/docs/KDS-ANTI-PATTERNS.md
```
...
```bash
git add .github/sessions/current-session.json
