...
- feature.prompt.md (3740 lines) ← NEW, largest file
- question.prompt.md
...
**High Priority**:
1. ⚠️ feature.prompt.md not integrated with task.prompt.md handoff (3 SP)
2. ⚠️ feature.prompt.md not in SystemIndex.md (1 SP)
3. ⚠️ feature.prompt.md too large at 3740 lines, needs module extraction (5 SP)
...
**Low Priority**:
7. feature.prompt.md missing version tag (1 SP)
...
**Adjusted for feature.prompt.md integration needs**: **8.7/10** (Good)
...
1. **Execute High-Priority Actions** (8 SP, ~4-6 hours)
   - Integrate feature.prompt.md with task.prompt.md
   - Add feature.prompt.md to SystemIndex.md
   - Extract shared modules from feature.prompt.md
...
- `.github/instructions/Links/SystemIndex.md` (328→391 lines)
  - Added feature.prompt.md to "Active Prompt Agents" with comprehensive description
  ...
  - Enhanced "Agent Coordination Protocols" to include feature planning agent
...
**Commit**: 86c51a77 (`feat(prompts): Extract shared modules from feature.prompt.md (Action 03)`)

**Files Created**:

1. **`.github/prompts/shared/image-analysis-protocol.md`** (487 lines)
   - Extracted from feature.prompt.md Step 0.6 (Image Analysis & Requirement Extraction)
   ...
   - Integration guidance for feature.prompt.md Step 0.6

2. **`.github/prompts/shared/phase-breakdown-patterns.md`** (450 lines)
   - Extracted from feature.prompt.md Planning Structure (Steps 2-4)
...
3. **`.github/prompts/feature.prompt.md`** (3740→2499 lines)
...
**Benefits**:
- ✅ Reduced feature.prompt.md size by 33% (now meets 2000-line recommendation)
...
**Validation**:
- feature.prompt.md: 2499 lines (target ~2500 achieved ✅)
...
4. 86c51a77 - feat(prompts): Extract shared modules from feature.prompt.md (Action 03)
...
- feature.prompt.md (3740→2499 lines) -1241 lines

### Net Change
- Total lines added: 1894 lines (new shared modules + report)
- Total lines removed: 1129 lines (from feature.prompt.md extractions)
...
- Action 07: Add version tag to feature.prompt.md - 1 SP
