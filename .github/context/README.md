...
**Script:** `.github/scripts/sensors/build-knowledge-graph.ps1`
...
**Query Functions:** `.github/scripts/sensors/query-knowledge-graph.ps1`
...
**When It Runs:**
- Via orchestrator: `.github/scripts/sensors/run-all-sensors.ps1` (after all sensors)
- Manual: `.github/scripts/sensors/build-knowledge-graph.ps1 -Mode Full`
- Incremental: `.github/scripts/sensors/build-knowledge-graph.ps1 -Incremental`
...
**Generated By:** `.github/scripts/sensors/build-knowledge-graph.ps1`  
**Schema:** `knowledge-graph.json.schema`  
