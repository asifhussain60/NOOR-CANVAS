...
**Scope**: feature.prompt.md, task.prompt.md, test-generation.prompt.md
...
1. **Check if key folder exists**: `.github/prompts.keys/{key}/`
   ...
   - Error message:
     ...
     REQUIRED ACTION:
     1. Run planning agent: @workspace /feature key={key} user_request="..."
...
**This step has been moved to feature.prompt.md Step 0.6.**
...
**Generation:** feature planning agent creates comprehensive test suite specification in final phase:
...
(Generated by feature planning agent - see Comprehensive Test Suite section above)
...
4. ✅ Add branch parameter validation to feature.prompt.md (Step 0.1)
...
1. ✅ Move image analysis to feature.prompt.md (Step 0.6)
...
1. ✅ Add comprehensive test suite generation to feature.prompt.md
...
**Problem:**
- feature planning agent discovers technology stack in Step 0.5
