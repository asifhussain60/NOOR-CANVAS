...
# Scans .github/sessions/ and extracts historical patterns

param(
    [string]$SessionsPath = ".github/sessions",
    [string]$BrainPath = ".github/kds-brain"
)
...
Write-Host "     #file:.github/prompts/internal/brain-updater.md" -ForegroundColor White
Write-Host "`n  2. Or manually trigger update:" -ForegroundColor Gray
Write-Host "     #file:.github/prompts/user/kds.md Update BRAIN with all events" -ForegroundColor White
