...
Path to .github/context directory (default: ./.github/context)

.PARAMETER OutputPath
Path to save knowledge-graph.json (default: ./.github/context/knowledge-graph.json)
...
if (-not $ContextPath) {
    # Scripts are in .github/scripts/sensors, context is in .github/context
