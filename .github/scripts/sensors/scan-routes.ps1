...
.PARAMETER OutputPath
    Path to output routes.json (default: .github/context/routes.json)

.PARAMETER Mode
    Scan mode: Full or Incremental (default: Incremental)

.EXAMPLE
    .github/scripts/sensors/scan-routes.ps1
...
param(
    ...
    [Parameter(Mandatory=$false)]
    [string]$OutputPath = ".github/context/routes.json",
...
# Determine workspace root (go up 3 levels from .github/scripts/sensors)
