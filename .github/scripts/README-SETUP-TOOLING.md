...
**Version:** 1.0.0  
**Location:** `.github/scripts/setup-kds-tooling.ps1`  
...
```powershell
# From project root
.\.github\scripts\setup-kds-tooling.ps1
```

### Options
```powershell
# Skip Node.js packages
.\.github\scripts\setup-kds-tooling.ps1 -SkipNodePackages

# Skip .NET packages
.\.github\scripts\setup-kds-tooling.ps1 -SkipDotNetPackages

# Force reinstall (even if already installed)
.\.github\scripts\setup-kds-tooling.ps1 -Force

# Skip final validation
.\.github\scripts\setup-kds-tooling.ps1 -SkipValidation
```
...
**CURRENT APPROACH:**
- Session state: JSON files (`.github/sessions/`)
- Knowledge base: Markdown files (`.github/knowledge/`)
- Version control: Git
...
mkdir .github
Copy-Item -Recurse D:\PROJECTS\NOOR-CANVAS\.github\* .\.github\
```
