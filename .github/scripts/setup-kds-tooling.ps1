...
function Show-DatabaseAnalysis {
    ...
    Write-Host "  • Session state: JSON files (.github/sessions/)" -ForegroundColor White
    Write-Host "  • Knowledge base: Markdown files (.github/knowledge/)" -ForegroundColor White
