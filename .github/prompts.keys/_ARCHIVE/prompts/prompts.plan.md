...
- .github/prompts/feature.prompt.md (current orchestration structure)
...
- plan.json schema (feature.prompt.md lines 590-700)
...
1. Add test index query to feature.prompt.md Step 0.5
...
**Files to Analyze**:
- .github/prompts/feature.prompt.md (Step 0.5 Technology Stack Discovery)
...
- [ ] **Task 2.1**: Add Step 0.5.7 to feature.prompt.md - "Reusable Test Discovery"
...
**Manual Validation**:
1. Run feature planning agent with feature="user registration"
...
- feature.prompt.md Step 0.5.7: Query test index for matching tests
...
1. Add Step 10 to feature.prompt.md for post-completion learning
...
**Files to Analyze**:
- .github/prompts/feature.prompt.md (current Step 9 is final step)
...
- [ ] **Task 3.1**: Add Step 10 to feature.prompt.md - "Learning Extraction"
...
- [ ] **Task 3.4**: Document skip option
  ...
  - Add to feature.prompt.md parameters section
  - Default: false (automatic extraction)

### Validation Checklist

- [ ] Build passes (no syntax errors)
- [ ] Step 10 added to feature.prompt.md
...
- feature.prompt.md Step 10: Learning Extraction (final step)
...
1. Define key reuse vs creation rules in feature.prompt.md Step 0.2
...
**Files to Analyze**:
- .github/prompts/feature.prompt.md (parameter validation)
...
- [ ] **Task 5.1**: Add Step 0.2 to feature.prompt.md - "Key Reuse Strategy"
...
- [ ] Build passes (no syntax errors)
- [ ] Step 0.2 added to feature.prompt.md
- [ ] Domain matching logic documented
- [ ] Archival criteria defined
- [ ] active.keys.log format updated
- [ ] Manual test: feature planning agent applies decision tree
- [ ] Commit: [SHA]
...
**Manual Validation**:
1. Run feature planning agent with key="prompts"
2. Verify Step 0.2 recommends reuse (same domain)
3. Run feature planning agent with key="new-feature"
...
- feature.prompt.md Step 0.2: Key Reuse Strategy (decision tree)
...
2. Run: @workspace /feature key=test-enhancements user_request="Add feature X"
...
- [ ] **Phase 2**: Test Reuse in Planning
  - [ ] Implementation complete
  - [ ] Build passes
  - [ ] Validation: feature planning agent queries test index
  - [ ] Commit: [SHA]
  - [ ] Tag: checkpoint/prompts/2025-10-20_phase2
...
- [ ] **Phase 5**: Key Management Strategy
  - [ ] Implementation complete
  - [ ] Build passes
  - [ ] Validation: feature planning agent applies reuse rules
  - [ ] Commit: [SHA]
  - [ ] Tag: checkpoint/prompts/2025-10-20_phase5
...
- Run feature planning agent, verify reusable tests discovered
...
- .github/prompts/feature.prompt.md (orchestration structure)
- .github/prompts/task.prompt.md (execution workflow)
