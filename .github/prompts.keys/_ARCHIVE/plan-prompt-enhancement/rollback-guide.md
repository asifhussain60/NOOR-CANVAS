...
# Check file contents
cat .github/prompts/feature.prompt.md | Select-String "Phase Breakdown Algorithm"
...
- **Files Affected**: 1 file (feature.prompt.md)
...
- **Files Affected**: 1 file (feature.prompt.md) + documentation
