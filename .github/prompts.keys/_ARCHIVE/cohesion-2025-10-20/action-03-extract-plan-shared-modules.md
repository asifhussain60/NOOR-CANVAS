...
feature.prompt.md is 3740 lines (largest prompt in system). Extract reusable sections to shared modules to improve maintainability and enable reuse across other agents.
...
**Current State**:
- feature.prompt.md: 3740 lines (too large)
...
**Target State**:
- feature.prompt.md: ~2500 lines (after extraction)
...
**Source**: feature.prompt.md, Step 0.6 (Image Analysis via Vision API)  
**Lines**: ~150-200 lines  
...
**Usage**:
- feature.prompt.md references for Step 0.6
...
## Examples
[Include examples from feature.prompt.md]
```

### Step 2: Extract Phase Breakdown Patterns

**Source**: feature.prompt.md, Step 2-4 (Phase breakdown, dependencies, test planning)  
**Lines**: ~200-250 lines  
...
**Usage**:
- feature.prompt.md references for Step 2-4
...
**Source**: feature.prompt.md, Step 6 (Handoff to task.prompt.md)  
**Lines**: ~100 lines  
...
### Step 4: Update feature.prompt.md with References

After extraction, update feature.prompt.md to reference shared modules:
...
- [ ] feature.prompt.md reduced from 3740 to ~2500 lines
...
- [ ] Read feature.prompt.md in full
- [ ] Identify extraction candidates
- [ ] Verify no overlap with existing shared modules

### Post-Implementation Checks
- [ ] feature.prompt.md size: ~2500 lines (was 3740)
...
- [ ] All references in feature.prompt.md valid
- [ ] Build succeeds
...
1. `.github/prompts/feature.prompt.md` - Reduce ~1200 lines, add 3 references
...
- Analyze feature.prompt.md: 30 minutes
...
- Update feature.prompt.md references: 30 minutes
