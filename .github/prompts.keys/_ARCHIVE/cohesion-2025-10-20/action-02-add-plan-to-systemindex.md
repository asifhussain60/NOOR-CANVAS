...
feature.prompt.md is a major new agent (3740 lines) added 2025-10-20 but not documented in SystemIndex.md. This makes the planning agent non-discoverable for users.
...
- feature.prompt.md not included despite being comprehensive (3740 lines)
- Users don't know Feature Planning Agent exists
...
- **feature.prompt.md** ⭐ - Interactive planning for complex implementations (requirement refinement, phased execution, test plans)
```
...
1. **feature.prompt.md** - Refine requirements, generate phased plan
...
- [ ] Verify feature.prompt.md is not already documented
- [ ] Identify best location for new entry

### Post-Implementation Checks
- [ ] feature.prompt.md in "Active Prompt Agents" section
- [ ] feature.prompt.md in "Quick Navigation" section
