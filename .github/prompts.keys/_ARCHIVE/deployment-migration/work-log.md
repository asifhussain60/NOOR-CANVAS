...
1. **`.github/prompts/feature.prompt.md`** (added ~350 lines):
...
**Impact**:
- feature planning agent now detects DB changes and includes migration creation in phase specs
...
2. **Agent Integration** (Phase 2):
   - feature.prompt.md: Database Migration Protocol
