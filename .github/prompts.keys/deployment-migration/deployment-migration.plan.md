...
- **Agent Protocols**: plan.prompt.md, task.prompt.md, test-generation.prompt.md
...
**Files to Modify**:
- `.github/prompts/plan.prompt.md` (add migration protocol)
...
1. Update plan.prompt.md to detect database changes
...
- [ ] **Task 2.1**: Update plan.prompt.md Step 0.5 (Technology Stack Discovery)
  - Expected: Add database change detection logic
  
- [ ] **Task 2.2**: Add new section to plan.prompt.md: "Database Migration Protocol"
...
- [ ] plan.prompt.md updated with database detection
- [ ] Migration protocol documented in plan.prompt.md
...
- plan.prompt.md: Database change detection + migration protocol
